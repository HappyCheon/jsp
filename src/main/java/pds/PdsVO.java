...
public class PdsVO {
  ...
  //날짜형식필드를 '문자'와 '숫자'로 저장시켜주기 위한 변수를 선언
	...
	public String toString() {
		return "PdsVO [idx=" + idx + ", mid=" + mid + ", midIdx=" + midIdx + ", nickName=" + nickName + ", fName=" + fName
				+ ", fSName=" + fSName + ", fSize=" + fSize + ", title=" + title + ", part=" + part + ", pwd=" + pwd
				+ ", fDate=" + fDate + ", downNum=" + downNum + ", openSw=" + openSw + ", content=" + content + ", wCdate="
				+ wCdate + ", wNdate=" + wNdate + "]";
	}
}
