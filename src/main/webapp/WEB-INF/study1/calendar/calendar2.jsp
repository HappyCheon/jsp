...
<div class="container">
  <div class="text-center">
    <button class="btn btn-secondary btn-sm" onclick="location.href='${ctp}/calendar2.st?yy=${yy-1}&mm=${mm}';" title="이전년도">◁◁</button>
    <button class="btn btn-secondary btn-sm" onclick="location.href='${ctp}/calendar2.st?yy=${yy}&mm=${mm-1}';" title="이전월">◀</button>
    &nbsp; <font size="5">${yy}년 ${mm+1}월</font> &nbsp;
    <button class="btn btn-secondary btn-sm" onclick="location.href='${ctp}/calendar2.st?yy=${yy}&mm=${mm+1}';" title="다음월">▶</button>
    <button class="btn btn-secondary btn-sm" onclick="location.href='${ctp}/calendar2.st?yy=${yy+1}&mm=${mm}';" title="다음년도">▷▷</button>
    &nbsp; &nbsp; 
    <button class="btn btn-secondary btn-sm" onclick="location.href='${ctp}/calendar2.st';" title="오늘날짜"><i class="fa fa-home"></i></button>
  </div>
  <br/>
  <div>
